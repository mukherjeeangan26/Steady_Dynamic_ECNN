...
% This code develops steady-state ECNN models for the cases when no noise
...
data = xlsread('Steady-State HX Data.xlsx','NoNoise');
% data = xlsread('Steady-State HX Data.xlsx','ConstantBias+Gaussian Noise');
data = data(:,2:end);
